...
mainMenuButtonHolder.databaseLaunchButton = '<button id="databaseLaunchButton" class="accordion"><img src="../BAM/images/open-iconic/magnifying-glass.svg" class="accordianImage" alt="info">&nbsp;&nbsp;&nbsp;&nbsp;Search People and Interests</button>';
...
mainMenuButtonHolder.connectionsListLaunchButton = '<button id="connectionsListLaunchButton" class="accordion"><img src="../BAM/images/network-diagram.svg" class="accordianImage" alt="info">&nbsp;&nbsp;&nbsp;&nbsp;All Connections List</button>';
